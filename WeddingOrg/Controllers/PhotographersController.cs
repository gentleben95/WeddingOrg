...
//        {
//            var photographer = await _weddingsRepository.GetWeddings(cancellationToken);
//            return wedding;
//        }

//        //GET api/<WeddingsController>/5 
//        [HttpGet("{id}")]
//        public async Task<ActionResult<int>> GetWeddingById(int id, CancellationToken cancellationToken)
//        {
